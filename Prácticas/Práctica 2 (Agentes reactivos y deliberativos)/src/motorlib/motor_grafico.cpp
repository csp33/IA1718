...
void botonElegirMapaCB(int valor) {
    ...
    panelSelecMapa->add_radiobutton_to_group(group, "Nivel 1");
    panelSelecMapa->add_radiobutton_to_group(group, "Nivel 2");
    panelSelecMapa->add_radiobutton_to_group(group, "Nivel 3");
